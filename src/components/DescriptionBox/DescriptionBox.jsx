    ...
    <div className='descriptionbox'>
      ...
      <div className="descriptionbox-description">
        <p>An e-commerce website is an online platform that facilitates the buying and 
            ...
            to their convenience accessibility, and the globle reach they offer.
        </p>
        <p>
            E-commerce websites typically display products or services along with details
            descriptions images, prices , and any available variation eg size colors.Each
            product usually has its own detailed page with relevant introduction.
        </p>
      </div>
    </div >
  )
